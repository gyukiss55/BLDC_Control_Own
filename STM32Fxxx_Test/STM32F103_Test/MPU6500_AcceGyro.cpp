...
void dumpMPU6500(String& message) {
    xyzFloat gValue = myMPU6500.getGValues();
    xyzFloat gyr = myMPU6500.getGyrValues();
    float temp = myMPU6500.getTemperature();
    float resultantG = myMPU6500.getResultantG(gValue);

	message = "\nAcce:" + String(gValue.x) + "," + String(gValue.y) + "," + String(gValue.z);
    message += "\nGval:" + String(resultantG);
    message += "\nGyro: " + String(gyr.x) + "," + String(gyr.y) + "," + String(gyr.z);
    message += "\nTemp:" + String(temp) ;
}